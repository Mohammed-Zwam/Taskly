    ...
    return [
      {
        ...
        path: '/projects',
        icon: `
        <svg class="w-[20px] h-[20px]"  viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      },
      {
        ...
        icon: `
        <svg class="w-[20px] h-[20px]" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      },
      {
        ...
        icon: `
        <svg class="w-[20px] h-[20px]" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      },
      {
        ...
        icon: `
        <svg class="w-[20px] h-[20px]" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      },
      {
        ...
        icon: `
        <svg class="w-[20px] h-[20px] text-inherit" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
